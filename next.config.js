...
module.exports = (phase) => {
  ...
  const csp = [
    ...
    `img-src 'self' data: blob: https://*.pellwood.com https://pellwood-strapi.hardart.cz https://pawdlzmdumjinndgowct.supabase.co${isDev ? ' http://localhost:1337' : ''}`,
    "font-src 'self' data:",
    `connect-src 'self' https://*.pellwood.com https://*.google-analytics.com https://*.analytics.google.com https://*.seznam.cz https://pawdlzmdumjinndgowct.supabase.co https://pellwood-strapi.onrender.com${isDev ? ' http://localhost:1337 ws://localhost:*' : ''}`,
    "frame-src 'none'",
